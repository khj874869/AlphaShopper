...
public class FakePaymentGateway implements PaymentGateway {
    ...
    @Override
    public PaymentResult authorize(PaymentMethod paymentMethod, BigDecimal amount, String paymentReference, Long orderId) {
        ...
        String transactionKey = paymentMethod.name() + "-" + orderId + "-" + UUID.randomUUID().toString().substring(0, 8);
        return new PaymentResult(true, transactionKey, "APPROVED");
    }

    @Override
    public boolean refund(String transactionKey, BigDecimal amount) {
