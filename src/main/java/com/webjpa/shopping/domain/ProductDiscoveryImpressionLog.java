...
@Entity
@Table(name = "product_discovery_impression_log")
public class ProductDiscoveryImpressionLog {

    private static final int MAX_QUERY_LENGTH = 1000;
    private static final int MAX_PRODUCT_NAME_LENGTH = 120;
    private static final int MAX_HIGHLIGHTS_LENGTH = 1000;
    private static final int MAX_IMPRESSION_KEY_LENGTH = 160;
    ...
    @Column(length = MAX_IMPRESSION_KEY_LENGTH)
    private String impressionKey;

    @Column(nullable = false)
    private LocalDateTime shownAt;

    protected ProductDiscoveryImpressionLog() {
    }

    private ProductDiscoveryImpressionLog(Long memberId,
        ...
        this.impressionKey = truncate(impressionKey, MAX_IMPRESSION_KEY_LENGTH);
        this.shownAt = LocalDateTime.now();
    }

    public static ProductDiscoveryImpressionLog create(Long memberId,
                                                       ProductDiscoverySurface surface,
                                                       String queryText,
                                                       Long productId,
                                                       String productName,
                                                       ...
                                                       List<String> highlights,
                                                       String impressionKey) {
        return new ProductDiscoveryImpressionLog(
                memberId,
                surface,
                queryText,
                productId,
